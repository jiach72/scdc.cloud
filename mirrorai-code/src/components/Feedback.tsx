      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              MirrorAI Code&apos;s functionality (eg. to reduce the risk of bugs
