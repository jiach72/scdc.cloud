...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when MirrorAI Code was first started on this machine
  ...
  // MirrorAI Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first MirrorAI Code OAuth token
  ...
  // MirrorAI Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
