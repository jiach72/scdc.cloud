...
const APP_NAME = 'MirrorAI Code URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'MirrorAI Code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>MirrorAI Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for MirrorAI Code
