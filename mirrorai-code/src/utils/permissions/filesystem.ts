...
// Always ask when MirrorAI Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by MirrorAI Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by MirrorAI Code)
