...
/**
 * Resolve MirrorAI Code-specific path patterns for sandbox-runtime.
 *
 * MirrorAI Code uses special path prefixes in permission rules:
...
/**
 * Convert MirrorAI Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where MirrorAI Code started)
